...
const styles: Record<string, React.CSSProperties> = {
  ...
  backLink: { fontSize: "14px", fontWeight: 600, color: "var(--growth)", textDecoration: "none" },
  actionButton: { fontSize: "13px", fontWeight: 600, color: "var(--pine)", background: "var(--white)", border: "1px solid var(--line)", borderRadius: 8, padding: "6px 14px", cursor: "pointer" },
  ...
  headline: { fontSize: "14px", color: "var(--pine)", margin: 0 },
  ...
  quote: { fontSize: "15px", color: "var(--pine)", margin: "0 0 8px", lineHeight: 1.5, fontStyle: "italic" },
  entryMeta: { fontSize: "13px", color: "var(--muted)", margin: 0 },
  frameworkTag: { fontSize: "12px", color: "var(--growth)", margin: "6px 0 0" },
