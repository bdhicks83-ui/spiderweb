...
const styles: Record<string, React.CSSProperties> = {
  ...
  quoteText: { fontSize: "14px", color: "var(--ink)", margin: "6px 0 0", lineHeight: 1.55, fontStyle: "italic" as const },
  ...
  formatOptionOn: { borderColor: "var(--accent)", background: "var(--accent-soft)" },
  formatOptionTop: {
    display: "flex",
    alignItems: "center",
    gap: 8,
  ...
  formatOptionName: { fontSize: "16px", fontWeight: 700, color: "var(--ink)" },
  formatOptionNameSmall: { fontSize: "14px", fontWeight: 700, color: "var(--ink)" },
  formatOptionEffort: { fontSize: "12px", color: "var(--muted)" },
  formatOptionWhy: { fontSize: "14px", color: "var(--ink-soft)", margin: 0, lineHeight: 1.55 },
  formatOptionWhySmall: { fontSize: "13px", color: "var(--ink-soft)", margin: 0, lineHeight: 1.5 },
  recommendedChip: {
    fontSize: "11px",
    fontWeight: 700,
  ...
  tradeoff: { fontSize: "13px", color: "var(--ink-soft)", margin: "4px 0 0", lineHeight: 1.5 },
  ...
  strategyLine: { fontSize: "14px", color: "var(--ink-soft)", margin: "0 0 12px", lineHeight: 1.5 },
  ...
  watchText: { fontSize: "14px", color: "var(--ink-soft)", margin: "0 0 10px", lineHeight: 1.55 },
  ...
  readaptText: { fontSize: "14px", color: "var(--ink)", margin: "6px 0 0", lineHeight: 1.55 },
  enhanceCard: {
    marginTop: 12,
    background: "var(--paper-2)",
    border: "1px solid var(--line)",
  ...
  enhanceLabel: { fontSize: "14px", fontWeight: 700, color: "var(--ink)" },
  enhanceHint: { fontSize: "12px", color: "var(--muted)", margin: "4px 0 0", lineHeight: 1.5 },
  enhanceItem: { fontSize: "13px", color: "var(--ink-soft)", margin: "8px 0 0" },
  provenCard: {
    marginTop: 20,
