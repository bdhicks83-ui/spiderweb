...
const styles: Record<string, React.CSSProperties> = {
  ...
  center: { minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', fontFamily: 'var(--font-sans)', textAlign: 'center', padding: '24px' },
  title: { fontSize: '26px', fontWeight: 700, margin: 0 },
  subtitle: { fontSize: '15px', color: 'var(--pine-soft)', margin: '0 0 8px', lineHeight: 1.5 },
  field: { display: 'flex', flexDirection: 'column', gap: '6px' },
  label: { fontSize: '13px', fontWeight: 600, color: 'var(--pine-soft)' },
  textarea: { width: '100%', fontSize: '15px', padding: '10px 12px', borderRadius: '8px', border: '1px solid var(--line)', fontFamily: 'inherit', boxSizing: 'border-box' },
  select: { width: '100%', fontSize: '14px', padding: '10px 12px', borderRadius: '8px', border: '1px solid var(--line)', fontFamily: 'inherit', background: 'var(--white)' },
  primary: { padding: '12px 24px', fontSize: '16px', fontWeight: 600, color: 'var(--white)', background: 'var(--growth)', border: 'none', borderRadius: '10px', cursor: 'pointer', alignSelf: 'flex-start' },
  ...
  savedBadge: { fontSize: '16px', fontWeight: 600, color: 'var(--ok-text)', backgroundColor: 'var(--ok-bg)', border: '1px solid var(--ok-border)', borderRadius: '9999px', padding: '8px 16px', margin: 0 },
  savedText: { fontSize: '15px', color: 'var(--pine-soft)', margin: 0 },
