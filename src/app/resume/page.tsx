...
const styles: Record<string, React.CSSProperties> = {
  ...
  help: { margin: '0 0 8px', fontSize: '14px', color: 'var(--pine-soft)', lineHeight: 1.5 },
  card: { padding: '24px', backgroundColor: 'var(--white)', border: '1px solid var(--line)', borderRadius: '14px', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', display: 'flex', flexDirection: 'column', gap: '8px' },
  label: { fontSize: '13px', fontWeight: 600, color: 'var(--pine-soft)', marginTop: '4px' },
  ...
  errorText: { marginTop: '4px', fontSize: '14px', color: 'var(--danger)' },
  inlineLink: { color: 'var(--danger)', fontWeight: 600, textDecoration: 'underline' },
  doneBox: { marginTop: '8px', padding: '16px', background: 'var(--ok-bg)', border: '1px solid var(--ok-border)', borderRadius: '10px', display: 'flex', flexDirection: 'column', gap: '8px' },
  doneText: { margin: 0, fontSize: '14px', color: 'var(--ok-text)', fontWeight: 600 },
  downloadLink: { fontSize: '14px', fontWeight: 600, color: 'var(--growth-deep)', textDecoration: 'none' },
};
