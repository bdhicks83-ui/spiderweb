...
const styles: Record<string, React.CSSProperties> = {
  ...
  introText: { margin: 0, fontSize: '15px', lineHeight: 1.6, color: 'var(--ink)' },
  resumeCard: {
    display: 'flex',
    flexDirection: 'column',
    gap: '12px',
  ...
  triggerLabel: { fontSize: '13px', fontWeight: 600, color: 'var(--ink)', textAlign: 'center' },
  methodCard: {
    display: 'flex',
    flexDirection: 'column',
    gap: '6px',
  ...
  methodListItemActive: { borderColor: 'var(--accent)', backgroundColor: 'var(--accent-soft)' },
  ...
  ladderLabelActive: { color: 'var(--ink)', fontWeight: 600 },
  softWarning: {
    margin: 0,
    fontSize: '13px',
    color: 'var(--warn-text)',
  ...
  bubbleYou: { alignSelf: 'flex-end', backgroundColor: 'var(--ink)', color: 'var(--on-ink)' },
  bubbleEngine: {
  ...
  frameworkTagline: { fontSize: '15px', color: 'var(--ink-soft)', margin: 0, lineHeight: 1.5 },
  ...
  frameworkItem: { fontSize: '14px', lineHeight: 1.55, color: 'var(--ink)' },
  frameworkPara: { margin: 0, fontSize: '14px', lineHeight: 1.6, color: 'var(--ink)' },
  signalsCard: {
    backgroundColor: 'var(--ok-bg)',
    border: '1px solid var(--ok-border)',
    borderRadius: '8px',
