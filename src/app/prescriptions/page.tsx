...
const URGENCY_CHIP: Record<string, { color: string; bg: string; border: string }> = {
  ...
  Low: { color: "var(--pine-soft)", bg: "var(--paper-2)", border: "var(--line)" },
};
...
const styles: Record<string, React.CSSProperties> = {
  ...
  rank: { fontSize: "13px", fontWeight: 700, color: "var(--growth)" },
  roi: {
    fontSize: "11px",
    fontWeight: 700,
    color: "var(--growth-deep)",
  ...
  pairing: { fontSize: "13px", color: "var(--pine-soft)", margin: "0 0 8px", lineHeight: 1.5 },
