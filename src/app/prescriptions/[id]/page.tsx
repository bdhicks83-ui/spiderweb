...
const styles: Record<string, React.CSSProperties> = {
  ...
  tbAnswer: { fontSize: "13px", color: "var(--ink-soft)", margin: "0 0 6px", lineHeight: 1.5 },
  ...
  evidenceTagline: { fontSize: "13px", color: "var(--ink-soft)", margin: "0 0 8px", lineHeight: 1.4 },
  evidenceSnippet: { fontSize: "13px", color: "var(--ink-soft)", margin: "4px 0 0", lineHeight: 1.5 },
  rankBox: {
    background: "var(--accent-soft)",
    border: "1px solid var(--leaf-light)",
    borderRadius: 12,
