          ...
          <>
            ...
            {efficacyEvidence.map((r) => (
              <a
                key={r.id}
                href={`/library/${r.id}`}
                style={{ ...styles.evidenceCard, borderColor: "var(--danger-border)", background: "var(--danger-bg)" }}
              >
                <div style={styles.evidenceTop}>
                  <span style={styles.evidenceName}>
                    {r.trigger_type ? `${TRIGGER_EMOJI[r.trigger_type] ?? ""} ` : ""}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  detailText: { fontSize: "13px", color: "var(--muted)", margin: "8px 0 0", lineHeight: 1.5 },
  ...
  approvalLine: { fontSize: "13px", color: "var(--ok-text)", margin: "0 0 14px" },
  approveButton: {
    fontSize: "14px",
    fontWeight: 600,
    color: "var(--white)",
  ...
  captureFootnote: { fontSize: "12px", color: "var(--warn-text)", margin: "8px 0 0", lineHeight: 1.5 },
  fidelityBox: {
    background: "var(--white)",
    border: "1px solid var(--line)",
    borderRadius: 12,
  ...
  fidelityConfirmed: { fontSize: "13px", color: "var(--ok-text)", fontWeight: 600 },
  fidelityRejected: { fontSize: "13px", color: "var(--danger)", fontWeight: 600 },
  fidelityPending: { fontSize: "13px", color: "var(--warn-text)" },
  fidelityActions: { marginTop: 10, borderTop: "1px solid var(--line)", paddingTop: 10 },
  rejectedCallout: {
    fontSize: "13px",
    color: "var(--danger)",
    background: "var(--danger-bg)",
  ...
  tbScorePass: { fontSize: "14px", fontWeight: 700, color: "var(--ok-text)" },
  tbScoreFail: { fontSize: "14px", fontWeight: 700, color: "var(--warn-strong)" },
  tbScenarioSmall: { fontSize: "13px", color: "var(--muted)", margin: "0 0 6px", lineHeight: 1.5 },
  tbAnswer: { fontSize: "13px", color: "var(--pine-soft)", margin: "0 0 6px", lineHeight: 1.5 },
  tbFeedback: { fontSize: "13px", color: "var(--ok-text)", margin: "0 0 6px", lineHeight: 1.5 },
  tbMissed: { fontSize: "13px", color: "var(--warn-text)", margin: 0, lineHeight: 1.5 },
  efficacyBox: {
    border: "1px solid",
    borderRadius: 12,
    padding: "14px 16px",
  ...
  conflictLink: { color: "var(--warn-strong)", textDecoration: "none", fontWeight: 600 },
  sectionTitle: {
    fontSize: "13px",
    textTransform: "uppercase",
    letterSpacing: "0.04em",
  ...
  evidenceMeta: { fontSize: "12px", color: "var(--muted)" },
  evidenceTagline: { fontSize: "13px", color: "var(--pine-soft)", margin: "0 0 8px", lineHeight: 1.4 },
  evidenceSnippet: { fontSize: "13px", color: "var(--pine-soft)", margin: "4px 0 0", lineHeight: 1.5 },
  rankBox: {
    background: "var(--growth-soft)",
    border: "1px solid var(--new-leaf-light)",
    borderRadius: 12,
